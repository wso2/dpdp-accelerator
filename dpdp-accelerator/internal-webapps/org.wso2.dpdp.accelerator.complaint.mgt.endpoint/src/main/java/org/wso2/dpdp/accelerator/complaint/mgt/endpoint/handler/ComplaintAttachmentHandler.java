...
public class ComplaintAttachmentHandler {
    ...
    public List<ComplaintAttachmentResponseBean> uploadComplaintAttachments(String orgId, String complaintId,
        ...
        List<ComplaintAttachmentDTO> result =
    ...
    public List<ComplaintAttachmentResponseBean> uploadCommentAttachments(String orgId, String complaintId,
        ...
        List<UploadedFile> files = toUploadedFiles(fileParts);
        List<ComplaintAttachmentDTO> result = complaintAttachmentService.uploadCommentAttachments(orgId, complaintId,
    ...
    public ComplaintAttachmentDownloadResponseBean downloadAttachment(String orgId, String complaintId,
        ...
        ComplaintAttachmentDTO dto =
                complaintAttachmentService.downloadAttachment(orgId, complaintId, attachmentId, actorRole);
        return new ComplaintAttachmentDownloadResponseBean(dto.getAttachmentId(), dto.getFileName(),
                dto.getContentType(), dto.getContent());
    }
        ...
        for (FormDataBodyPart part : fileParts) {
            try (InputStream in = part.getValueAs(InputStream.class)) {
                ...
                throw new ComplaintException("CO-4002", "Validation failed",
                        "Could not read uploaded file content.", 422);
            }
        }
        return files;
    }
    ...
    private List<ComplaintAttachmentResponseBean> toBeans(List<ComplaintAttachmentDTO> dtos) {
        List<ComplaintAttachmentResponseBean> beans = new ArrayList<>();
        for (ComplaintAttachmentDTO dto : dtos) {
            beans.add(new ComplaintAttachmentResponseBean(dto.getAttachmentId(), dto.getFileName(),
                    dto.getContentType(), dto.getSizeBytes()));
        }
        return beans;
    }
}
