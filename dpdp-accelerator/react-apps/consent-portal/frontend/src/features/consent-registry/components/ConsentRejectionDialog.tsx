...
function ConsentRejectionDialog({
  ...
  return (
    <ConsentActionDialog
      open={open}
      consentId={consentId}
      title={t('consentRegistry.modals.rejection.title')}
      message={t('consentRegistry.modals.rejection.message')}
      note={t('consentRegistry.modals.rejection.note')}
      confirmLabel={t('consentRegistry.modals.rejection.confirm')}
      color="error"
      icon={<Ban size={16} />}
      loading={loading}
      error={error}
...
ConsentRejectionDialog.defaultProps = {
  error: undefined,
}
